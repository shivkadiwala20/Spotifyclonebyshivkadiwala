...
Array.from(document.getElementsByClassName(`song-items`)).forEach((e,i) =>{
...
//     Array.from(document.getElementsByClassName('song-items')).forEach((el) => {
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e)=>{
    e.addEventListener(`click`,(el)=>{
        ...
        makeAllBackground();
        Array.from(document.getElementsByClassName('song-items'))[index-1].style.background="rgb(105,105,105,.1)";
        makeAllPlays();
